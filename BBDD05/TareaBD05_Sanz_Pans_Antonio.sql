...
COMMIT;
--CORRECCION DE LOS INSERT DEL EJERCICIO 7
INSERT INTO M_TOTAL_VENTAS (ID_MED, UNIDADES_VENDIDAS, TOTAL_VENTAS)
SELECT 
  ID_MED, 
  UNIDADES_VENDIDAS, 
  UNIDADES_VENDIDAS * (SELECT PRECIO_UNIT FROM M_MEDICAMENTOS WHERE M_MEDICAMENTOS.ID_MED = V.ID_MED)
FROM (
  VALUES
    (1, 13),
    (2, 7),
